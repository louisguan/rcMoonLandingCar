      ...
      default:
        ...
        else if (_index == _frameLen + 2 + 1)
        {
          ...
          if (_calculatedChecksum == _checksum)
          {
            ...
            // Particles Number
            _data->PM_PN_UG_0_3 = makeWord(_payload[12], _payload[13]);
            _data->PM_PN_UG_0_5 = makeWord(_payload[14], _payload[15]);
            _data->PM_PN_UG_1_0 = makeWord(_payload[16], _payload[17]);
            _data->PM_PN_UG_2_5 = makeWord(_payload[18], _payload[19]);

            // Tmperature & Humidity
            _data->Tmperature = makeWord(_payload[20], _payload[21]);
